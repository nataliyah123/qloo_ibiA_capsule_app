  ...
  const mockArtifacts: Artifact[] = [
    {
      ...
      metadata: {
        ...
        url: 'https://bookshop.org/books/the-mindful-way-through-depression',
        rating: 4.6,
        category: 'Psychology'
      },
      orderIndex: 0
    },
    {
      ...
      metadata: {
        ...
        url: 'https://podcasts.apple.com/podcast/science-wellbeing',
        rating: 4.8,
    ...
    },
    {
      ...
      metadata: {
        ...
        url: 'https://www.opentable.com/candle-cafe',
        rating: 4.4,
        category: 'Vegetarian'
      },
      orderIndex: 2
    ...
    },
    {
      ...
      metadata: {
        ...
        url: 'https://classpass.com/mindful-movement',
        rating: 4.5,
        category: 'Mind-Body'
      },
      orderIndex: 4
